...
2. Add a new variable:
   - Key: `SECRET_KEY`
   - Value: Generate a secure random string (e.g., use `python -c "import secrets; print(secrets.token_hex(32))"`)
3. This is required for session security and CSRF protection.
