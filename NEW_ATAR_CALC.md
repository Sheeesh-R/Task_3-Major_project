...
- **matrix.edu.au ATAR calculator** — exact (HSC mark, scaled mark) pairs at HSC marks 20, 40–50, 70–80, and 85–90 across all subjects
...
#### HSC Mark = 20 for all (low-end anchor points, matrix.edu.au)

These are critical low-end anchor points that pin the polynomial curve at the bottom of the mark range, preventing wild extrapolation below HSC 60.

| Subject | HSC Mark | Scaled Mark |
|---|---|---|
| English Standard | 20 | 8.2 |
| English Advanced | 20 | 14.1 |
| English Ext. 1 | 20 | 17.3 |
| English Ext. 2 | 20 | 17.9 |
| General Maths | 20 | 8.4 |
| Maths Advanced | 20 | 14.1 |
| Maths Ext. 1 | 20 | 19.4 |
| Maths Ext. 2 | 20 | 21.6 |
| Biology | 20 | 11.9 |
| Chemistry | 20 | 14.9 |
| Physics | 20 | 14.3 |
| Earth & Environmental Science | 20 | 9.8 |
| Senior Science | 20 | 6.5 |
| Business Studies | 20 | 9.3 |
| Economics | 20 | 15.2 |
| Legal Studies | 20 | 10.4 |
| Studies of Religion I | 20 | 12.3 |
| Studies of Religion II | 20 | 11.9 |
| Ancient History | 20 | 10.4 |
| History Extension | 20 | 17.8 |
| Modern History | 20 | 11.3 |
| ESL | 20 | 7.6 |
| Community & Family Studies | 20 | 6.6 |
| Society & Culture | 20 | 9.1 |
| PDHPE | 20 | 9.1 |
| Design & Technology | 20 | 7.9 |
| Software Design & Development | 20 | 10.1 |
| Textiles & Design | 20 | 8.3 |
| Engineering Studies | 20 | 11.1 |
| Industrial Technology | 20 | 5.6 |
| Drama | 20 | 9.1 |
| Music 1 | 20 | 7.5 |
| Music 2 | 20 | 13.7 |
| Music Extension | 20 | 13.5 |
| Visual Arts | 20 | 7.7 |
...
| English Standard | 12+ | ✅ Good |
| English Ext. 1 | 9 | ✅ Good |
| English Ext. 2 | 12 | ✅ Good |
| Maths Ext. 2 | 9 | ✅ Good |
| Maths Ext. 1 | 11 | ✅ Good |
| Maths Advanced | 11 | ✅ Good |
| Maths Standard 2 / General | 12 | ✅ Good |
| Physics | 9 | ✅ Good |
| Chemistry | 11 | ✅ Good |
| Biology | 10 | ✅ Good |
| Investigating Science | 7 | ✅ Good |
| Earth & Environmental Science | 9 | ✅ Good |
| Senior Science | 2 | ⚠️ Moderate — HSC 20 anchor + matrix pair only, use degree 2 |
| Economics | 9 | ✅ Good |
| Business Studies | 9 | ✅ Good |
| Legal Studies | 9 | ✅ Good |
| Studies of Religion I | 11 | ✅ Good |
| Studies of Religion II | 2 | ⚠️ Moderate — HSC 20 anchor + matrix pair only, use degree 2 |
| Geography | 11 | ✅ Good |
| Modern History | 12 | ✅ Good |
| Ancient History | 11 | ✅ Good |
| History Extension | 4 | ⚠️ Moderate — HSC 20 anchor + 3 matrix pairs, use degree 3 |
| PDHPE | 9 | ✅ Good |
| Society & Culture | 10 | ✅ Good |
| Community & Family Studies | 10 | ✅ Good |
| ESL | 2 | ⚠️ Moderate — HSC 20 anchor + matrix pair only, use degree 2 |
| Dance | 7 | ⚠️ Moderate — no data below HSC 79, use degree 3 |
| Software Design & Development | 8 | ✅ Good |
| Software Engineering | 7 | ✅ Good |
| Food Technology | 9 | ✅ Good |
| Engineering Studies | 9 | ✅ Good |
| Design & Technology | 8 | ✅ Good |
| Industrial Technology | 10 | ✅ Good |
| Textiles & Design | 2 | ⚠️ Moderate — HSC 20 anchor + matrix pair only, use degree 2 |
| Drama | 3 | ⚠️ Moderate — HSC 20 anchor + 2 matrix pairs, use degree 2 |
| Music 1 | 3 | ⚠️ Moderate — HSC 20 anchor + 2 matrix pairs, use degree 2 |
| Music 2 | 3 | ⚠️ Moderate — HSC 20 anchor + 2 matrix pairs, use degree 2 |
| Music Extension | 3 | ⚠️ Moderate — HSC 20 anchor + 2 matrix pairs, use degree 2 |
| Visual Arts | 3 | ⚠️ Moderate — HSC 20 anchor + 2 matrix pairs, use degree 2 |

No subjects remain at ❌. The HSC=20 anchor points eliminated all thin-data subjects — every subject now has at least a low-end pin and one mid-range point to work from.

**Remaining gaps to fill for better accuracy:**
- Senior Science, Studies of Religion II, ESL, Textiles & Design — grab hscscalinggraphs.au curves for these
- Creative Arts block (Drama, Music 1/2/Extension, Visual Arts) — still only 3 points each, more curve data would help significantly
